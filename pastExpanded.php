...
<div class="w3-content" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-col" style="width:80%" >
    	<div class="w3-white w3-text-black w3-card-4 w3-margin-bottom w3-margin-top" style="height:900px">
    		<div class="topnav">
    			<form action="phpscript.php" method="post" target="_self">

    			<br>
    			<span style="float:right"><button type="Hide" value="1" name="hide" 
    				  style="background-color:transparent; border:transparent;" 
    				  class="w3-margin-right w3-text-grey">Hide</button></span>

    			<text class="w3-margin-left" style="font-size: 20px">Patient History:</text><br/>
    			<br>
          <br>
